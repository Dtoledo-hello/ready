!(function ($) {
    $.fn.floatingWhatsApp = function (e) {
      var _,
        t,
        a = $.extend(
          {
      ...
      if (
        (n.addClass("floating-wpp-button-image"),
        s
          .addClass("floating-wpp-button")
          .append($(a.buttonImage))
          .css({
            width: a.size,
            height: a.size,
        ...
        (!(
          0 <= (o = window.navigator.userAgent).indexOf("MSIE") ||
          o.match(/Trident.*rv\:11\./)
        ) ||
          a.showOnIE) &&
          s.append(n).appendTo(this),
        s.on("click", function () {
          i && a.showPopup ? w() : u();
        }),
        a.showPopup)
        ...
        function w() {
          p.hasClass("active") || (p.addClass("active"), g.focus());
        }
        p.addClass("floating-wpp-popup"),
          l.addClass("floating-wpp-head"),
          c.addClass("floating-wpp-message"),
          r.addClass("floating-wpp-input-message"),
          d.addClass("floating-wpp-btn-send"),
          c.text(a.popupMessage),
          g.val(a.message),
          a.popupMessage || c.hide(),
          l
            .append("<span>" + a.headerTitle + "</span>", m)
            .css("background-color", a.headerColor),
          d.append(h),
          r.append(g, d),
          m.addClass("close").html("&times;"),
          p.append(l, c, r).appendTo(this),
          c.click(function () {}),
          m.click(function () {}),
          l.click(function () {
      ...
      a.zIndex && $(this).css("z-index", a.zIndex),
        "right" === a.position &&
          (this.css({ left: "auto", right: "15px" }), p.css("right", "0"));
    };
  })(jQuery);
